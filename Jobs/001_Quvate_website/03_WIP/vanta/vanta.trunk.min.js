! function(e) {
    ...
    1: function(e, t, i) {
        ...
        n.VantaBase = class {
            constructor(e = {}) {
                var t, i, r, a;
                if (n.current = this, this.onMouseMoveWrapper = this.onMouseMoveWrapper.bind(this), this.resize = this.resize.bind(this), this.animationLoop = this.animationLoop.bind(this), this.restart = this.restart.bind(this), this.options = Object(s.c)({}, this.defaultOptions), e instanceof HTMLElement || "string" == typeof e ? Object(s.c)(this.options, {
                        el: e
                    }) : Object(s.c)(this.options, e), this.el = this.options.el, null == this.el) o('Instance needs "el" param!');
                else if (!(this.options.el instanceof HTMLElement || (a = this.el, this.el = Object(s.e)(a), this.el))) return void o("Cannot find element", a);
                ...
                try {
                    ...
                    return i = e, o("Init error"), o(i), this.el.removeChild(this.renderer.domElement), void(this.options.backgroundColor && (console.log("[VANTA] Falling back to backgroundColor"), this.el.style.background = this.color2Hex(this.options.backgroundColor)))
                }
            ...
            onMouseMoveWrapper(e) {
                var t, i, s;
                t = this.renderer.domElement.getBoundingClientRect(), i = this.mouseX = e.clientX - t.left, s = this.mouseY = e.clientY - t.top, i >= 0 && s >= 0 && !this.options.mouseEase && this.triggerMouseMove(i, s)
            }
    ...
    14: function(e, t, i) {
        ...
        class o extends s.b {
            ...
            onInit() {
                ...
                this.p5 = new p5(function(t) {
                    ...
                    function d(e, i, s) {
                        let n = e % t.TWO_PI;
                        return n < 0 && (n += t.TWO_PI), t.noise(u + t.cos(n) * i, l + t.sin(n) * i, c + s)
                    }
                    t.setup = function() {
                        e.initP5(t), t.strokeWeight(1), t.stroke(Object(n.a)(e.options.color)), t.smooth(), t.noFill()
                    }, t.draw = function() {
                        t.clear(), t.translate(t.width / 2, t.height / 2),
                            function() {
                                l -= .02, c += .005;
                                for (let e = 0; e < i; e++) {
                                    t.beginShape();
        ...
        o.initClass(), s.a.register("TRUNK", o)
    },
    3: function(e, t, i) {
        "use strict";
        i.d(t, "b", function() {
